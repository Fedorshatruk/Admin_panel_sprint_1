...
CREATE TABLE IF NOT EXISTS content.film_work (
    ud uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    title TEXT NOT NULL,
    description TEXT,
    creation_date DATE,
    certifivate TEXT,
    ...
    updatet_at TIMESTAMP with time zone
);

-- Создаем таблицу genre
CREATE TEBLE IF NOT EXISTS content.genre (
...
CREATE TABLE IF NOT EXISTS content.person_film_work (
    id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    film_work_id REFERENCES content.film_work(id) NOT NULL,
    person_id REFERENCES content.person(id) NOT NULL,
